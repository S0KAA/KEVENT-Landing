function displayDownloadButtons(latestReleaseVersion) {
  const downloadButtonsSection =
    document.getElementsByClassName('download-buttons')
  const downloadOpenSection = document.getElementsByClassName('download-open')
  ...
  const latestReleaseUrl =
    'https://github.com/S0KAA/KEVENT-Launcher/releases/latest/download'
...
<path d="M12 16L3 16 3 23.75 12 24.988zM12 5L3 6.25 3 14 12 14zM14 4.75L14 14 27 14 27 3zM14 16L14 25.25 27 27 27 16z"></path>
  ...
  downloadButtonsSection[0].style.display = 'flex'
  downloadOpenSection[0].style.display = 'block'
}

export default displayDownloadButtons
